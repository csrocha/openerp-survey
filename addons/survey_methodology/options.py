...
class options(osv.osv):
    """"""
    _name = 'survey_methodology.options'
    ...
    _columns = {
        ...
        'question_selection_id': fields.many2one('survey_methodology.question', string='question_selection_id', ondelete='cascade', required=True), 
    }
