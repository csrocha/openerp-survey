            ...
            for r in rows:
                ...
                if questionnaire_ids:
                    ...
                    try:
                        ...
                        raise osv.osv(_('Import error in line %i') % nl, _('Please check column version is a number. Value is \'%s\' or \'%s\'') % (parameters.get(column_version, 0), rdict[column_version]))
