...
class survey(osv.osv):
    ...
    _columns = {
        ...
        'closed_message': fields.html(string='Closed Survey message', readonly=True, states={'draft':[('readonly',False)]}),
        'last_message': fields.html(string='Last message', readonly=True, states={'draft':[('readonly',False)]}),
