...
class communication_batch(osv.osv):
    ...
    _columns = {
        'email_parameter_name': fields.char(string='email_parameter_name', required=True),
        'email_subject': fields.char(string='email_subject', required=True),
        'email_body': fields.text(string='email_body', required=True),
        'email_reply_to': fields.char(string='email_reply_to', required=True),
        'email_copy_to': fields.char(string='email_copy_to'),
